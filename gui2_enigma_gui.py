...
def enigma_gui(config):
    ...
    # ---- enigma alphabet (26 charactersa --------------------------
    ...
    layoutx = [ [sg.Text(font=font30,text_color='black',key='-IN-',
                         background_color='white',size=(1,1)),
                 sg.Text('->',text_color='black',font=font30),
                 sg.Text(font=font30,text_color='black',key='-OUT-',
                         background_color='white',size=(1,1))],

                [sg.Button('Exit',font=font4),
                 sg.Button('Clear',font=font4),
